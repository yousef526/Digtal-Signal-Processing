...
0.949263346546471f,
        ...
        public void AutoFastNormalizedCorrelationTestMethod1()  
        {
            ...
            fc.Run();
            Console.WriteLine(expectedOutput.Samples[0]);
            Console.WriteLine(expectedOutput.Samples[1]);
            Console.WriteLine(expectedOutput.Samples[2]);
            Console.WriteLine(expectedOutput.Samples[3]);
        ...
        public void CrossFastNormalizedCorrelationTestMethod2()
        {
            ...
            Console.WriteLine(expectedOutput.Samples.Count);
            Console.WriteLine(fc.InputSignal1.Samples.Count);
            Console.WriteLine(fc.InputSignal2.Samples.Count);
            fc.Run();
